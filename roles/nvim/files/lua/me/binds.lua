...
local function imap(lhs, rhs, opts)
    set("i", lhs, rhs, opts or defaultOpts)
end
local function xmap(lhs, rhs, opts)
    set("x", lhs, rhs, opts or defaultOpts)
end
local function smap(lhs, rhs, opts)
    set("s", lhs, rhs, opts or defaultOpts)
end
local function vmap(lhs, rhs, opts)
    set("v", lhs, rhs, opts or defaultOpts)
end
local function tmap(lhs, rhs, opts)
    set("t", lhs, rhs, opts or defaultOpts)
end
...
-- Append line below, keep cursor in same place
nmap("J", "mzJ`z")

-- Jump up/down page, keep cursor in same place
nmap("<C-u>", "<C-u>zz")
nmap("<C-d>", "<C-d>zz")
